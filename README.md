...
| -----------                                           | ----------- |
| [Trafic Light Fault Monitoring Board](#trafic-fault)  | <span style="background-color:green">Embedded</span> ,```Software Design```, ```Hardware Troubleshooting```, ```PCB with Liligo Board``` , `ESP8266 SoC` , `GSM`, `Wifi` , `Customer-driven`|
